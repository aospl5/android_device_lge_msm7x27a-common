...
/**
 * Provides SignalStrength correction for old Lge RIL
 */
public class LgeMsm7x27aRIL extends RIL {

    public LgeMsm7x27aRIL(Context context, int preferredNetworkType, int cdmaSubscription) {
        super(context, preferredNetworkType, cdmaSubscription);
       mQANElements = 5;
    }

    public LgeMsm7x27aRIL(Context context, int preferredNetworkType, int cdmaSubscription, Integer instanceId) {
